...
3. **B2A1 to A2B1**: The mapped CMYK is feed back through A2B1 tag and converted to Absolute colorimetric value before comparing with the input L* a* b* using delta E.
